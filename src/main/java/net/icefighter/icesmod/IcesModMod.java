package net.icefighter.icesmod;
...
@Mod("ices_mod")
public class IcesModMod {
	public static final Logger LOGGER = LogManager.getLogger(IcesModMod.class);
	public static final String MODID = "ices_mod";
	...
	public IcesModMod() {
		...
		IcesModModSounds.REGISTRY.register(bus);
